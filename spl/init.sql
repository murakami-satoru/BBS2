...
insert into departments (name) values ('管理者');
insert into departments (name) values ('総務人事担当者');
insert into departments (name) values ('情報管理担当者');
